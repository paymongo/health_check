  ...
  class HealthCheckController < ActionController::Base
    ...
    def index
      ...
      if stale?(last_modified: last_modified, public: is_public)
        ...
        if errors.blank?
          send_response true, nil, :ok, :ok, process_errors
          ...
          send_response false, msg, HealthCheck.http_status_for_error_text, HealthCheck.http_status_for_error_object, process_errors
    ...
    def send_response(healthy, msg, text_status, obj_status, process_errors)
      ...
      binding.pry
      obj = { healthy: healthy, message: msg, response: process_errors[:body]}
